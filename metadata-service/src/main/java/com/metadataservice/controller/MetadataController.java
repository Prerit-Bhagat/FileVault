...
//     @Get("/{fileId}")
//     public HttpResponse<?> get(@PathVariable String fileId) {
//         return metadataService.getByFileId(fileId)
//                 .map(HttpResponse::ok)
...
// //     @Get("/{fileId}")
// //     public String debug(@PathVariable String fileId) {
// //         return "FOUND: " + fileId;
// //     }
...
//     @Get("/{fileId}")
//     public HttpResponse<?> getMetadata(@PathVariable String fileId) {
...
public class MetadataController {
    ...
    @Post
    public HttpResponse<FileMetadata> save(@Body FileMetadata metadata) {
        FileMetadata saved = metadataService.saveMetadata(metadata);
        return HttpResponse.created(saved);
    }
